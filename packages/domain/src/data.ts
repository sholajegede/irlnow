import type { EventAccess } from "./events/access";
/**
 * Names a cover image without owning the file.
 *
 * Each platform maps these keys to its own bundled assets — the web app
 * through Vite, the mobile app through Metro — so the domain stays free of
 * any bundler.
 */
